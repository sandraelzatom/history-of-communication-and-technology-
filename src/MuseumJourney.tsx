...
// ── Era definitions with chronological visual drift ───────────────────────────
const eras = [
  {
    id: "01",
    ...
    symbol: "—·—·",
    // ANALOG ERA: heavy, warm, dense
    bg: "#F2EAD8",           // aged paper
    border: "#0D0D0D",
    borderWidth: "3px",
    accent: "#8B3A2A",       // oxidized copper-red
    accentLight: "#C4602A",
    textPrimary: "#1A0F08",
  ...
  },
  {
    ...
    symbol: "☏",
    // TRANSITION: warm amber, medium weight
    bg: "#F5F0E0",
    border: "#0D0D0D",
    borderWidth: "2.5px",
    accent: "#1B3A6B",       // deep telegraph blue
    accentLight: "#2B5FA8",
    textPrimary: "#0D1B2A",
  ...
  },
  {
    ...
    symbol: "~∿~",
    // TRANSITION: lighter, airier, mid-century
    bg: "#F8F5EE",
    border: "#0D0D0D",
    borderWidth: "2px",
    accent: "#C17B00",       // amber broadcast
    accentLight: "#E8A800",
    textPrimary: "#1C1208",
  ...
  },
  {
    ...
    symbol: "01",
    // DIGITAL ERA: weightless, cold white, razor thin
    bg: "#FAFAFA",
    border: "#0D0D0D",
    borderWidth: "1px",
    accent: "#D7263D",       // digital red signal
    accentLight: "#FF4458",
    textPrimary: "#0D0D0D",
...
// ── Era Card ──────────────────────────────────────────────────────────────────
function EraCard({ era, index, onVisible }: { era: typeof eras[0]; index: number; onVisible: (i: number) => void }) {
  ...
  return (
    ...
    >
      {/* Paper texture for telegraph */}
      {era.hasTexture && <PaperTexture />}

      {/* Digital era: faint grid overlay */}
      {isDigital && (
        <div
      ...
      {/* Accent top bar — thicker for older eras */}
      <div
        style={{
      ...
      <div className={`p-6 ${isDigital ? "lg:grid lg:grid-cols-5 lg:gap-8" : ""}`}>
        ...
        {/* Right: artifact info (digital era gets a larger callout) */}
        <div
